 ...
 */
//static void print_rank_globals(int rank_id, char *str)
//{
//  fprintf(stdout, "%s:%d GLOBALS\n block_amt=%zu\ninitial_quantum=%f\n", str,rank_id, block_amt, fabs(quantum) * 1000000.0);
//  fflush(stdout);
//  //block_amt = 0;
//  //quantum = 0.0;
//  //initial_quantum = 0.0;
...
{
  //fprintf(stdout, "World size: %d\nRank: %d\n", FTI_Topo->nbProc, FTI_Topo->myRank);
  //print_rank_globals(rank_id, "MONITOR");
  //int ret;
  char str[FTI_BUFS];
